...
import 'package:clone_whatsapp/Pages/ChatPage/ChatBox.dart';
import 'package:clone_whatsapp/Utils/iconUtil.dart';
import 'package:clone_whatsapp/Utils/textUtil.dart';
import 'package:clone_whatsapp/model/Mensagem.dart';
import 'dart:async';
          ...
          child: Center(
            child: Row(
              ...
              children: [
                ...
                IconAvatar(urlImage: urlImage, nameOfPerson: nameContact, abrirPopup: true),
              ],
            ),
          ),
        ),
